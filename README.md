...
page that breaks down the city's ~8.5 million residents 24 different ways — by
...
housing and more — plus three centuries of population history.
...
scripts/build_data.py   # transforms raw estimates -> docs/data.json
